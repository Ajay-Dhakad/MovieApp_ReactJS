    ...
    <>
      <div className="movie-results" >
          ...
          <>
            {currentpage == 1 && (
              <div className="searchresultcount">
                <p>
                  {movieData.totalResults} Results found for <b>{movie}</b>
                </p>
              </div>
            )}
        ...
        {movieData?.Response == "False" && (
          <div className="loader-container">No Movies Found For {movie}</div>
        )}
        ...
        {movieData?.Response != "False" && movieData?.totalResults > 10 && (
          <div className="pagesnavigation">
            <button
              ...
              onClick={() => {
                ...
                if (currentpage >= 1)
                  navigate(`/search/${movie}/page/${String(currentpage - 1)}`);
              }}
            >
              PrevPage
            </button>
